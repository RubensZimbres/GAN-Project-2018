...
var = input("IMPORTANT NOTICE: Tensorboard will start AFTER you close the pop-up with MNIST digits output.\nWould you like to run Tensorboard after training? [y|n]")
